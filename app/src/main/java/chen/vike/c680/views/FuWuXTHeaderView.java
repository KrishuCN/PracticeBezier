 ...
 * android banner图
 */
public class FuWuXTHeaderView extends FrameLayout implements OnPageChangeListener {
    ...
    public FuWuXTHeaderView(Context context) {
        this(context, null);
    }

    public FuWuXTHeaderView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FuWuXTHeaderView(Context context, AttributeSet attrs, int defStyle) {

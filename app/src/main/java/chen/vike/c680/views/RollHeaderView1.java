 ...
 * android banner图
 */
public class RollHeaderView1 extends FrameLayout implements OnPageChangeListener {
    ...
    public RollHeaderView1(Context context) {
        this(context, null);
    }

    public RollHeaderView1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RollHeaderView1(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initView() {
        ...
        if (mContext.getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT) {
            vParams.height = (int) (DisplayUtil.getMobileHeight(mContext) * 0.2);
        } else {
    ...
    public void setImgUrlData(List<String> urlList) {
        ...
        if (mUrlList != null && !mUrlList.isEmpty()) {
            ...
            for (int i = 0; i < mUrlList.size(); i++) {
                ...
                if (i == 0) {
                    dotIv.setBackgroundResource(R.mipmap.yuandian_xuan);
                } else {
    ...
    public void onPageSelected(int position) {
        dotList.get(prePosition).setBackgroundResource(R.mipmap.yuandian);

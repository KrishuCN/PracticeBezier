 ...
 *
 */
public class TuKuNativeImageLoader {
    private LruCache<String, Bitmap> mMemoryCache;
    private static TuKuNativeImageLoader mInstance = new TuKuNativeImageLoader();
    private ExecutorService mImageThreadPool = Executors.newFixedThreadPool(1);


    private TuKuNativeImageLoader(){
        //获取应用程序的最大内存
     ...
     * @return
     */
    public static TuKuNativeImageLoader getInstance(){
        return mInstance;
    }

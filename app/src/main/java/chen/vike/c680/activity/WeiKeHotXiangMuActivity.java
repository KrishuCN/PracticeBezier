...
public class WeiKeHotXiangMuActivity extends BaseStatusBarActivity {
    ...
    private Handler hd = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == GET_INFO) {
                ...
                LhtTool.showNetworkException(WeiKeHotXiangMuActivity.this, msg);
            }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String a = getIntent().getStringExtra("data_type");
        map.put("data_type", a);
        map.put("num", 10);
        map.put("pages", 1);
    ...
    class Myadapter extends RecyclerView.Adapter<Myadapter.MyViewHoler> {
        ...
        public MyViewHoler onCreateViewHolder(ViewGroup parent, int viewType) {
            return new MyViewHoler(LayoutInflater.from(WeiKeHotXiangMuActivity.this).inflate(R.layout.xiangmu_list_item, null));
        }
        ...
        public void onBindViewHolder(MyViewHoler holder, final int position) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(WeiKeHotXiangMuActivity.this, TaskDetailsActivity.class);
            ...
            ImageLoadUtils.Companion.display(WeiKeHotXiangMuActivity.this,holder.civ,itemList.get(position).getGz_imgurl());
        }

...
import chen.vike.c680.activity.PersonUpdateZuoPinActivity;
...
public class GridViewAdapter extends android.widget.BaseAdapter {
    ...
    public int getCount() {
        ...
        if (count > PersonUpdateZuoPinActivity.Companion.getMAX_SELECT_PIC_NUM()) {
            return mList.size();
        } else {
            return count;
        }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (position < mList.size()) {
            ...
            ImageLoadUtils.Companion.display(mContext,iv,picUrl);

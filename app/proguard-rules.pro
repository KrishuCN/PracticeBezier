...
#-keep class chen.vike.c680.weike.frag.entiy.**{ *; }
#-keep class chen.vike.c680.person.entiy.**{ *; }
#-keep class chen.vike.c680.dianpu.entiy.**{ *; }
#-keep class chen.vike.c680.fabu.entiy.**{ *; }
#-keep class chen.vike.c680.faxian.entiy.**{ *; }
#-keep class chen.vike.c680.vipweike.entity.**{ *; }
#-keep class chen.vike.c680.statistics.entiy.**{ *; }
#-keep class chen.vike.c680.GuZhu.entiy.**{ *; }
#-keep class chen.vike.c680.statistics.entiy.**{ *; }
-keep class chen.vike.c680.bean.** { *; }
...
-keep class com.lht.vike.a680_v1.Main.Gson.** { *; }
